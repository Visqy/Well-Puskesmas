        ...
        do
        {
            ...
            if (option == "1")
            {
                ...
                if (dequeueStatus.find("Pemanggilan pasien") != string::npos)
                {
                    ...
                    {
                        int count;
                        string regisStatusArray[2], regisStatus;
                        ...
                        if (regisStatusArray[0].find("REGIS_DONE") != string::npos)
                        {
            ...
            else if (option == "2")
            {
                ...
                cout << "Tambah pasien berhasil" << endl;
            }
            else if (option != "3")
            {
    ...
    void handleDokter()
    {
        ...
        do
        {
            ...
            if (option == "1")
            {
                ...
                cin >> diagnosaPasien->hasilDiagnosa;
                time_t now = time(0);
                ...
                do
                {
                    ...
                    {
                        write(socket_, buffer("STOP_ADD_TREATMENT-\n"));
                        delete pBantu;
                        break;
                    }
            ...
            else if (option == "2")
            {
                do
                {
                    ...
                    if (option == "1")
                    {
                        bool isError;
                        int nomor;
                        string nama, alamat, tempatLahir, tanggalLahir, kontak;
                        do
                        {
                            isError = false;
                            ...
                            if (pasienStatus.find("PASIEN_FOUND") != string::npos)
                            {
                                ...
                                cin >> kontak;
                                write(socket_, buffer(nama + "-" + alamat + "-" + tempatLahir + "-" + tanggalLahir + "-" + kontak + "-" + "\n"));
                                // Respose from server
                                string userStatus;
                                read_until(socket_, dynamicBuffer, '\n');
                                istream is(&dynamicBuffer);
    ...
    void handlePasienQueue()
    {
        ...
        if (callStatus.find("Anda dipanggil!") != string::npos)
        {
            ...
            if (checkKey)
            {
                ...
                cout << "Silakan lanjut ke bagian Pemeriksaan Awal" << endl;
                handlePendaftaran();
            }
            else
            {
...
int main()
{
    ...
    if (choice == 'y' || choice == 'Y')
    {
        ...
        {
            UserType userType;
            loggedIn = client.login("pasien", "pasien123", userType);
            if (!loggedIn)
            {
